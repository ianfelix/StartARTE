        ...
        <div className="content card-content content-grid-pages">
          ...
          <div className="flex-card">
            <Card
              ...
              textCard="A renda ou bordado filé é característica do litoral de Alagoas, e nasceu do aproveitamento das redes, confeccionadas pelos maridos pescadores, e bordadas pelas mulheres em cores fortes e vibrantes características da região, presente nos barcos, nas casas e festas folclóricas, como o maracatu."
            />
          </div>
        </div>
      </section>
