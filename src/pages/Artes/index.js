        ...
        <div className="content card-content content-grid-pages">
          <div className="flex-card">
            <Card
              ...
              textCard="Cesta togeliforme ou balaio (wayála) confeccionada em fibra de uramã natural e tingida de preto, kettamárhi (desenho de um tipo de besouro) dos Povos Baniwa (artesão) do Alto Rio Negro na Bacia do Rio Içana."
            />
          </div>
          <div className="flex-card">
            <Card
          ...
          <div className="flex-card">
            <Card
              ...
              textCard="A madeira é utilizada para a fabricação de diversos trabalhos nas sociedades indígenas. Vários artefatos são produzidos como ornamentos, máscaras, banquinhos, bonecas, pequenas estatuetas, canoas, dentre vários outros."
            />
          </div>
        </div>
      </section>
